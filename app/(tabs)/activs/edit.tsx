        ...
        <View style={s.row}>
          <View style={s.half}>
            <FieldBlock label="Дата начала" t={t}>
              <DatePickerField value={start} onChange={setStart} placeholder="Не задано" t={t} disabled={isClosed} />
            </FieldBlock>
          </View>
          <View style={s.half}>
            <FieldBlock label="Дата конца" t={t}>
              <DatePickerField value={end} onChange={setEnd} placeholder="Не задано" t={t} disabled={isClosed} />
            </FieldBlock>
          </View>
        </View>
      )}
...
function DatePickerField({
  value, onChange, placeholder, t, disabled,
}: {
  value: Date | null;
  ...
  return (
    <>
      <TouchableOpacity
        style={[s.dateBtn, { backgroundColor: t.inputBg, borderColor: t.border }, disabled && s.fieldDisabled]}
        onPress={() => {
          if (disabled) return;
